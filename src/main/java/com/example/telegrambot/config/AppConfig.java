...
import com.example.telegrambot.dto.ListOfExchangeRatesOnDate;
...
public class AppConfig {
    ...
    public CentralRussianBankService cbrService() throws SOAPException {
        ...
        jaxb2Marshaller.setClassesToBeBound(
                GetXmlOfDate.class,
                GetListOfExchangeRatesOnDateResponse.class,
                ListOfExchangeRatesOnDate.class,
                ExchangeRateOnDate.class);
